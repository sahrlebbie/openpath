...
for USER in $(cat /opt/splunk/etc/apps/openpath/default/users.conf)
do
/opt/splunk/bin/splunk add user $USER -password Splunk@2018! -role admin -auth "admin:KrBpqtHnRpswx$$6mQEyzkdrWn!"
